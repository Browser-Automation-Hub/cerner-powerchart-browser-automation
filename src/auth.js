/**
 * auth.js — Authentication handler for Cerner PowerChart
 * Supports: SSO (Azure AD / ADFS), MFA (Duo Security / RSA SecurID)
 *
...
const BASE_URL = process.env.CERNER_URL || 'https://your-instance.cerner.com/login';
const USERNAME = process.env.CERNER_USERNAME;
const PASSWORD = process.env.CERNER_PASSWORD;
...
async function performLogin(page) {
  if (!USERNAME || !PASSWORD) {
    throw new Error(`Set CERNER_USERNAME and CERNER_PASSWORD in .env`);
  }

  console.log('Logging in to Cerner PowerChart...');
  await page.goto(BASE_URL, { waitUntil: 'networkidle2' });
